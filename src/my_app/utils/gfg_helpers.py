...
def get_logs_dir() -> str:
    ...
    # place logs folder inside the `my_app` package (one level above `utils`) during development
    app_dir = os.path.dirname(os.path.abspath(__file__))
    my_app_dir = os.path.dirname(app_dir)
    logs_dir = os.path.join(my_app_dir, "logs")
